...
export type GeneratedFetcherOptions<TBody, THeaders, TQueryParams, TPathParams> = {
	...
	signal?: AbortSignal;
} & GeneratedFetcherExtraProps;

export async function generatedFetch<
	TData,
	TError,
...
>({
	...
	queryParams,
	signal
}: GeneratedFetcherOptions<TBody, THeaders, TQueryParams, TPathParams>): Promise<TData> {
	try {
